...
export const statsQueries = {
  getTasksByStatus: (pid) =>
    queryAll('SELECT status,COUNT(*) as count FROM tasks WHERE project_id=? GROUP BY status', [pid]),
  getTasksByPriority: (pid) =>
    queryAll('SELECT priority,COUNT(*) as count FROM tasks WHERE project_id=? GROUP BY priority', [pid]),
  getTasksByType: (pid) =>
