...
Planning Mode can generate [dependency relationships](/features/dependencies) between tasks. When Claude determines that task B requires task A to be completed first, it creates a dependency edge.
