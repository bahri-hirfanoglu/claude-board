...
export const api = {
  ...
  ...(IS_TAURI ? {
    ...
    addDependency: (taskId, dependsOnId) => tauriCall('add_task_dependency', { taskId, dependsOnId }),
    removeDependency: (taskId, dependsOnId) => tauriCall('remove_task_dependency', { taskId, dependsOnId }),
    getTaskDependencies: (taskId) => tauriCall('get_task_dependencies', { taskId }),
