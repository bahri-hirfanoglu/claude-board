...
export const api = {
  ...
  ...(IS_TAURI ? {
    ...
    addDependency: (taskId, dependsOnId, conditionType) => tauriCall('add_task_dependency', { taskId: Number(taskId), dependsOnId: Number(dependsOnId), conditionType: conditionType || null }),
    removeDependency: (taskId, dependsOnId) => tauriCall('remove_task_dependency', { taskId: Number(taskId), dependsOnId: Number(dependsOnId) }),
    ...
    approvePlan: (projectId, tasks, model, dependencies, topic) => tauriCall('approve_plan', { projectId, tasks, model, dependencies, topic }),
