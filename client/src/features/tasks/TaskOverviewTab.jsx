  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
        ...
        {d.total_cost > 0 && <StatCard icon={Coins} label={t('detail.cost')} value={`$${d.total_cost.toFixed(4)}`} />}
        {d.num_turns > 0 && <StatCard icon={Activity} label={t('detail.turns')} value={d.num_turns} />}
      </div>
